...
REM
REM Generated by Vivado on Thu Jul 30 18:21:12 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj fifo_asyn_tb1_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fifo_asyn_tb1_vlog.prj -log xvlog.log
